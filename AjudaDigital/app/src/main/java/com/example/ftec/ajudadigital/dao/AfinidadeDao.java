...
public class AfinidadeDao extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String sql = "CREATE TABLE Afinidade (id INTEGER PRIMARY KEY, nome TEXT NOT NULL);";
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        String sql = "DROP TABLE IF EXISTS Afinidade";
        sqLiteDatabase.execSQL(sql);
